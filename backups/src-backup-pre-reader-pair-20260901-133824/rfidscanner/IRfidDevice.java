...
public interface IRfidDevice {
    ...
    /**
     * Start software-driven continuous inventory that runs without holding
     * the hardware trigger (used by Tag Count / Tag Locator).
     */
    void startInventoryContinuous() throws Exception;
